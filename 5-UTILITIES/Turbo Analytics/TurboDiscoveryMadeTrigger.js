...
class TurboDiscoveryMadeTrigger extends hz.Component {
    constructor() {
        super(...arguments);
    ...
    start() {
        ...
        this.connectCodeBlockEvent(this.entity, hz.CodeBlockEvents.OnPlayerEnterTrigger, (player) => {
            (0, TurboAnalytics_1.Analytics)()?.sendDiscoveryMade({ player, ...this.turboData }, this.firstTimeOnly);
        });
    }
}
TurboDiscoveryMadeTrigger.propsDefinition = {
