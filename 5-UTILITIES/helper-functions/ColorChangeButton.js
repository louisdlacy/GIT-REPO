...
exports.ColorChangeButton = void 0;
const hz = __importStar(require("horizon/core"));
class ColorChangeButton extends hz.Component {
    preStart() {
...
exports.ColorChangeButton = ColorChangeButton;
ColorChangeButton.propsDefinition = {
    trigger: { type: hz.PropTypes.Entity },
    color: { type: hz.PropTypes.Color },
    objectDetector: { type: hz.PropTypes.Entity },
    colorReceiver: { type: hz.PropTypes.Entity }
};
ColorChangeButton.ColorChangeEvent = new hz.LocalEvent("colorChangeEvent");
