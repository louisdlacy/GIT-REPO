...
class PanCameraTrigger extends hz.Component {
    start() {
        this.connectCodeBlockEvent(this.entity, hz.CodeBlockEvents.OnPlayerEnterTrigger, (player) => {
            ...
            if (this.props.cameraOffset !== undefined && this.props.cameraOffset !== null) {
                this.sendNetworkEvent(player, PlayerCamera_1.PlayerCameraEvents.SetCameraPan, { positionOffset: this.props.cameraOffset, translationSpeed: this.props.translationSpeed });
            }
            else {
...
PanCameraTrigger.propsDefinition = {
