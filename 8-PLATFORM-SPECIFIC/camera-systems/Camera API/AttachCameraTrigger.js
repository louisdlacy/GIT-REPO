...
class AttachCameraTrigger extends hz.Component {
    preStart() {
    ...
    OnPlayerEnterTrigger(player) {
        if (this.props.target !== undefined && this.props.target !== null) {
            this.sendNetworkEvent(player, PlayerCamera_1.PlayerCameraEvents.SetCameraAttachWithTarget, { target: this.props.target });
        }
        else {
...
AttachCameraTrigger.propsDefinition = {
