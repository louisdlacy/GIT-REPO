...
const shift = 'SHIFT';
const charLimit = 140;
const submit = new hz.NetworkEvent('submit');
class keyboard extends ui.UIComponent {
    constructor() {
        super(...arguments);
        this.panelWidth = height * 16.5;
        this.panelHeight = height * 9.6;
        this.upperCase = new ui.Binding(true);
        this.caps = new ui.Binding(false);
        this.shift = new ui.Binding(true);
        this.text = new ui.Binding('|');
        this.curser = new ui.Binding(0);
    }
    initializeUI() {
        return ui.View({
            children: [
    ...
    button(lowercase, uppercase, width, press, release) {
        return ui.Pressable({
            children: ui.Text({
