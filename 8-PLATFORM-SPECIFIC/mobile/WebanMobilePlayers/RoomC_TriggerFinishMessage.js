...
class RoomC_TriggerFinishMessage extends hz.Component {
    start() {
        this.connectCodeBlockEvent(this.entity, hz.CodeBlockEvents.OnPlayerEnterTrigger, (player) => {
            this.sendNetworkBroadcastEvent(sysEvents_1.sysEvents.OnDisplayHintHUD, { players: [player], text: this.props.message, duration: this.props.messageDuration });
        });
    }
}
RoomC_TriggerFinishMessage.propsDefinition = {
