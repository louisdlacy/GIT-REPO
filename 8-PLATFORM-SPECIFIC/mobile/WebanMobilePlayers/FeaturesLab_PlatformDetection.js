...
class FeaturesLab_PlatformDetection extends hz.Component {
    start() {
        this.connectCodeBlockEvent(this.entity, hz.CodeBlockEvents.OnPlayerEnterWorld, (player) => {
            (0, sysUtils_1.SetTextGizmoText)(this.entity, `Platform: ${player.deviceType.get()}`);
...
FeaturesLab_PlatformDetection.propsDefinition = {};
