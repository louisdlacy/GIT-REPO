...
class FeaturesLab_SetAvatarPoseOverride extends hz.Component {
    start() {
        this.connectCodeBlockEvent(this.entity, hz.CodeBlockEvents.OnPlayerEnterTrigger, (player) => {
            player.clearAvatarGripPoseOverride();
            (0, sysUtils_1.SetTextGizmoText)(this.props.clearAvatarPoseOverrideText, "Avatar Pose Override cleared");
        });
        this.connectCodeBlockEvent(this.entity, hz.CodeBlockEvents.OnPlayerExitTrigger, () => {
            (0, sysUtils_1.SetTextGizmoText)(this.props.clearAvatarPoseOverrideText, "Clear Avatar Pose Override");
        });
    }
}
FeaturesLab_SetAvatarPoseOverride.propsDefinition = {
