...
class FeaturesLab_SetAimAssist extends hz.Component {
    start() {
        const aimAssistTargetEntity = this.props.aimAssistTarget;
        if (aimAssistTargetEntity === undefined)
            return;
        ...
        if (this.entity.owner.get() !== this.world.getServerPlayer()) {
            this.connectCodeBlockEvent(this.entity, hz.CodeBlockEvents.OnPlayerEnterTrigger, (player) => {
                (0, sysUtils_1.SetTextGizmoText)(this.props.aimAssistText, "Aim Assist Target Set");
            ...
            this.connectCodeBlockEvent(this.entity, hz.CodeBlockEvents.OnPlayerExitTrigger, (player) => {
                (0, sysUtils_1.SetTextGizmoText)(this.props.aimAssistText, "Aim Assist Target Cleared");
                player.clearAimAssistTarget();
            });
        }
    }
}
FeaturesLab_SetAimAssist.propsDefinition = {
