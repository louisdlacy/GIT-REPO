...
class RoomC_SlingshotTargetScript extends hz.Component {
    start() {
        this.connectCodeBlockEvent(this.entity, hz.CodeBlockEvents.OnEntityEnterTrigger, (enteredBy) => {
            this.sendNetworkEvent(this.props.puzzleManager, sysEvents_1.sysEvents.OnFinishPuzzle, {});
        });
    }
}
RoomC_SlingshotTargetScript.propsDefinition = {
