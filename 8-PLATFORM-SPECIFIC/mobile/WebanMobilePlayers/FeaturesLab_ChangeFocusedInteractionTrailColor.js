...
class FeaturesLab_ChangeFocusedInteractionTrailColor extends hz.Component {
    constructor() {
        super(...arguments);
    ...
    start() {
        this.connectCodeBlockEvent(this.entity, hz.CodeBlockEvents.OnPlayerEnterTrigger, (player) => {
            ...
            (0, sysUtils_1.SetTextGizmoText)(this.props.changeTrailColorText, `Focused Interaction<br>Changed the trail color to ${this.colorStrings[this.currentColorIndex]}`);
        });
    }
}
FeaturesLab_ChangeFocusedInteractionTrailColor.propsDefinition = {
