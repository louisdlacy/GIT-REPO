...
exports.sysHintHUDEntity = void 0;
const hz = __importStar(require("horizon/core"));
const sysEvents_1 = require("sysEvents");
class sysHintHUDEntity extends hz.Component {
    start() {
        ...
        this.sendLocalBroadcastEvent(sysEvents_1.sysEvents.OnRegisterHintHUDEntity, { HUDEntity: this.entity, HUDComponent: this });
    }
    // Public function to update the text of this entity
    // This is called by the HintHUDManager
    UpdateHintHUDText(text) {
        this.props.Text?.as(hz.TextGizmo)?.text.set(text);
    }
}
exports.sysHintHUDEntity = sysHintHUDEntity;
sysHintHUDEntity.propsDefinition = {
