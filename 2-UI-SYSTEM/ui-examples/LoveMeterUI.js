...
(function (game) {
    ...
    let LoveMeterMode;
    (function (LoveMeterMode) {
        LoveMeterMode["Love"] = "love";
        LoveMeterMode["Friendship"] = "friendship";
        LoveMeterMode["DrinkingPartner"] = "drinking";
    })(LoveMeterMode = game.LoveMeterMode || (game.LoveMeterMode = {}));
    class LoveMeterUI extends ui_1.UIComponent {
        constructor() {
            super();
            this.panelWidth = 1080;
            this.panelHeight = 1080;
            // Mode selection handlers
            this.onSelectLoveMode = () => {
                this.stateBinding.set(state => ({
                    ...state,
                    mode: LoveMeterMode.Love
                }));
            };
            this.onSelectFriendshipMode = () => {
                this.stateBinding.set(state => ({
                    ...state,
                    mode: LoveMeterMode.Friendship
                }));
            };
            this.onSelectDrinkingPartnerMode = () => {
                this.stateBinding.set(state => ({
                    ...state,
                    mode: LoveMeterMode.DrinkingPartner
                }));
            };
            this.onJoinPlayer1 = (player) => {
                if (!player)
                    return;
                this.stateBinding.set(state => {
            ...
            this.onStart = () => {
                this.stateBinding.set(state => {
                    if (state.player1Joined && state.player2Joined && !state.calculating) {
                        if (this.props.startSound) {
                            const startGizmo = this.props.startSound.as(hz.AudioGizmo);
                            if (startGizmo) {
                                startGizmo.play();
                            }
                        }
                ...
                this.timerBinding.set(ui_1.Animation.timing(1, {
                    duration: 2500,
                    easing: ui_1.Easing.linear
                }), () => {
                    ...
                    if (this.props.resultSound) {
                        const resultGizmo = this.props.resultSound.as(hz.AudioGizmo);
                        if (resultGizmo) {
                            resultGizmo.play();
                        }
                    }
            ...
            this.stateBinding = new ui_1.Binding({
                started: false,
                calculating: false,
                percentage: 0,
                player1Name: 'Player 1',
            ...
            this.timerBinding = new ui_1.AnimatedBinding(0);
        }
        getMessage(percentage, mode) {
            switch (mode) {
        ...
        getFriendshipMessage(percentage) {
            if (percentage <= 5) {
        ...
        getDrinkingPartnerMessage(percentage) {
            if (percentage <= 5) {
                ...
                children: [
                    ...
                    (0, ui_1.View)({
                        ...
                        children: [
                            // Heart Image
                            (0, ui_1.Image)({
                                source: ui_1.ImageSource.fromTextureAsset(this.props.heartTexture),
                                style: {
                                    width: '100%',
                                    height: '100%',
                                    position: 'absolute'
                                ...
                                children: [
                                    ...
                                    (0, ui_1.Pressable)({
                                        ...
                                        style: {
                                            ...
                                            flex: 1,
                                            marginRight: 5,
                                            backgroundColor: this.stateBinding.derive(s => s.mode === LoveMeterMode.Love ? '#FF4081' : '#666666')
                                        },
                                        children: [
                                            (0, ui_1.Text)({
                                                text: 'LOVE ❤️',
                                    ...
                                    (0, ui_1.Pressable)({
                                        ...
                                        style: {
                                            ...
                                            marginRight: 5,
                                            marginLeft: 5,
                                            backgroundColor: this.stateBinding.derive(s => s.mode === LoveMeterMode.Friendship ? '#4CAF50' : '#666666')
                                        },
                                        children: [
                                            (0, ui_1.Text)({
                                                text: 'FRIEND 🤝',
                                    ...
                                    (0, ui_1.Pressable)({
                                        ...
                                        style: {
                                            ...
                                            flex: 1,
                                            marginLeft: 5,
                                            backgroundColor: this.stateBinding.derive(s => s.mode === LoveMeterMode.DrinkingPartner ? '#2196F3' : '#666666')
                                        },
                                        children: [
                                            (0, ui_1.Text)({
                                                text: 'DRINK 🍻',
    ...
    game.LoveMeterUI = LoveMeterUI;
})(game || (game = {}));
// Register the component outside the namespace
core_1.Component.register(game.LoveMeterUI);
