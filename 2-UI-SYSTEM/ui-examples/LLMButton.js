...
exports.LLMButton = void 0;
const hz = __importStar(require("horizon/core"));
class LLMButton extends hz.Component {
    preStart() {
...
exports.LLMButton = LLMButton;
LLMButton.propsDefinition = {
    trigger: { type: hz.PropTypes.Entity },
    npc: { type: hz.PropTypes.Entity }
};
LLMButton.ColorQueryEvent = new hz.LocalEvent("colorQueryEvent");
