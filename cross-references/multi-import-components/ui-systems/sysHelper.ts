...
import { AudioLabel } from "AudioManager";
...
export enum ManagerType {
  ...
  UI_GameOverlay = "UI_GameOverlay",
  UI_PopupManager = "UI_PopupManager",
  PlayerCameraManager = "PlayerCameraManager",
  UI_ConfirmationManager = "UI_ConfirmManager",
  UI_NotificationManager = "UI_NotifyManager",
  // LevelManager = "LevelManager",
  // InteractionController = "InteractionCtrl",
  // UI_Popup_LevelUp = "UI_Popup_LevelUp",
  // UI_Payout = "UI_Payout",
  // UI_Shop = "UI_Shop",
}
