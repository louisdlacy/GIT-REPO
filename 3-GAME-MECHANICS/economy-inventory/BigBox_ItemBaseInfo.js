...
exports.BigBox_ItemBaseInfo = void 0;
const hz = __importStar(require("horizon/core"));
/**
 * Immutable information about an item
 * Can be inherited from to create assets with additional properties
 */
class BigBox_ItemBaseInfo extends hz.Component {
    start() {
    }
}
exports.BigBox_ItemBaseInfo = BigBox_ItemBaseInfo;
BigBox_ItemBaseInfo.propsDefinition = {
