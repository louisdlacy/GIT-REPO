...
exports.SpeedBoostPickupEvents = void 0;
const hz = __importStar(require("horizon/core"));
exports.SpeedBoostPickupEvents = {
    OnPickupSpeedBoost: new hz.NetworkEvent('OnPickupSpeedBoost'),
};
class SpeedBoostPickupTz extends hz.Component {
    constructor() {
        super(...arguments);
    ...
    onTriggerEnter(player) {
        if (this.active) {
            ...
            this.sendNetworkBroadcastEvent(exports.SpeedBoostPickupEvents.OnPickupSpeedBoost, {
                player,
...
SpeedBoostPickupTz.propsDefinition = {
