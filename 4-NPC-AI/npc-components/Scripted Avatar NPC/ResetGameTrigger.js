...
class ResetGameTrigger extends hz.Component {
    start() {
    ...
    handleOnPlayerEnter() {
        ...
        this.sendLocalBroadcastEvent(GameManager_1.setGameState, { state: GameManager_1.GameState.Ready });
    }
}
ResetGameTrigger.propsDefinition = {};
