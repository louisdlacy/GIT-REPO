...
class StartGameTriggerExample extends hz.Component {
    start() {
    ...
    handleOnPlayerEnter() {
        this.sendLocalBroadcastEvent(GameManager_COMPLETE_1.setGameState, { state: GameManager_COMPLETE_1.GameState.Playing });
    }
}
StartGameTriggerExample.propsDefinition = {};
