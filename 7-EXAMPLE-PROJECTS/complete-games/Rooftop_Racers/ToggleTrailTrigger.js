...
class ToggleTrailTrigger extends PlayerEventTriggerBase_1.PlayerFireEventOnTriggerBase {
    constructor() {
        super(...arguments);
        this.toggle = false;
    }
    ...
    onPlayerEnterTrigger(_enteredBy) {
        this.toggle = !this.toggle;
        if (this.toggle) {
            this.sendLocalBroadcastEvent(GameUtils_1.CurveVisualizer.StopDrawingCurve, {});
        }
        else {
            this.sendLocalBroadcastEvent(GameUtils_1.CurveVisualizer.StartDrawingCurve, {});
        }
    }
}
