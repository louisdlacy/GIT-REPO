...
class PlayerBoostPowerUpTrigger extends PlayerEventTriggerBase_1.PlayerFireEventOnTriggerBase {
    onEntityEnterTrigger(_enteredBy) { }
    onEntityExitTrigger(_exitedBy) { }
    onPlayerExitTrigger(_exitedBy) { }
    onPlayerEnterTrigger(enteredBy) {
        this.sendNetworkEvent(enteredBy, Events_1.Events.onPlayerGotBoost, {});
    }
}
