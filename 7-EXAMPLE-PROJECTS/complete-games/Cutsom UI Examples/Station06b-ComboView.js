...
*/
const viewBorder = (0, ui_1.View)({
    children: [(0, ui_1.Text)({ text: "I can haz Borders!", style: { margin: 10 } })],
    style: {
        alignItems: "center",
        height: 100,
        backgroundColor: "black",
...
/*
  ...
  */
const viewNestedRow = (0, ui_1.View)({
    children: [
        (0, ui_1.Text)({ text: "Flex Row" }),
        viewSimple,
        MyButton({
            label: "Button",
            baseColor: "green",
...
*/
const viewNestedCombo = (0, ui_1.View)({
    children: [
        viewNestedRow,
        (0, ui_1.View)({
...
*/
class UIComponentViewCombo extends ui_1.UIComponent {
    constructor() {
        super(...arguments);
        this.panelHeight = 900; // default value is 500
        this.panelWidth = 990; // default value is 500
    }
    initializeUI() {
        return (0, ui_1.View)({
            // The View is defined as a Text element and the viewNestedCombo object.
            children: [
                (0, ui_1.Text)({ text: "Compose with rows and columns" }),
                viewNestedCombo,
            ],
            style: {
...
ui_1.UIComponent.register(UIComponentViewCombo);
